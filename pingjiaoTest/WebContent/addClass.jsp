...
<body>
<center><h3>增加班级信息</h3></center>
<%
String tid = request.getParameter("tid");
request.setAttribute("tid", tid);
%>

<form action='${pageContext.request.contextPath}/classModifyServlet?me=add' method="post">
    <table align="center" border="1" width="300px">
        <tr>
            ...
            <td>
                <input type="text" name="id" value='${requestScope.tid}'  />
            </td>
        </tr>
        <tr>
            <th>
