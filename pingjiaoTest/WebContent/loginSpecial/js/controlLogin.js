...
layui.use('layer', function () {
    //
		...
		var msgalert = '请正确输入用户名以及密码，区分大小写';
    ...
    $('input[type="button"]').click(function () {
        ...
        if (login == '') {
            ...
            //认证中..
           // fullscreen();
          //  alert(login+":"+pwd+":"+code+":"+CodeVal.toUpperCase());
            var Ajax = createAjax();
            var flag4 = false;
            ...
            var method = "GET";
            var url = document.getElementById("form2").action+"&login="+login+"&pwd="+pwd+"&code="+flag4;
            ...
            Ajax.onreadystatechange=function(){
            	if(Ajax.readyState==4){
    				if(Ajax.status==200){
    					//从服务器端中获得数据
    					//var now ="http://localhost:8080/T01.loginTerm";
